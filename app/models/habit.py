...
class Habit(Base):
    ...
    frequency_type: Mapped[FrequencyType] = mapped_column(Enum
                                                          (FrequencyType), nullable=False)
...
class HabitLog(Base):
    ...
    completed_date: Mapped[date] = mapped_column(Date, nullable=False, index=True)  # The date user marks habit as done
